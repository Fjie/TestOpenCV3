 ...
 */
public class CvCameraPreview extends SurfaceView
...
//        PreviewCallback
{
    ...
    public OnCameraFrameListener onCameraFrameListener;
    public OnCameraViewStartedListener onCameraViewStartedListener;
    public OnCameraViewStoppedListener onCameraViewStoppedListener;
    ...
    private void processEnterState(int state) {
        ...
        switch (state) {
            case STARTED:
                onEnterStartedState();
                if (onCameraViewStartedListener != null) {
                    onCameraViewStartedListener.onCameraViewStarted(frameWidth, frameHeight);
                }
                break;
            case STOPPED:
                onEnterStoppedState();
                if (onCameraViewStoppedListener != null) {
                    onCameraViewStoppedListener.onCameraViewStopped();
                }
                break;
        }
    }
...
//            filter.stop();
     ...
     */
    private void deliverAndDrawFrame(Frame frame) {
        Mat processedMat = null;
        if (onCameraFrameListener != null) {
            Mat mat = converterToMat.convert(frame);
            processedMat = onCameraFrameListener.onCameraFrame(mat);
    ...
    private SurfaceHolder.Callback surfaceHolderCallback = new SurfaceHolder.Callback() {
         ...
         * required {cameraDevice}'s parameters and starts the preview stream.
         *
         * @param holder
         */
        @Override
    ...
    public interface OnCameraViewStartedListener{
        void onCameraViewStarted(int width, int height);
    }

    public interface OnCameraViewStoppedListener{
