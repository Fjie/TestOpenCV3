 ...
 */
public class JavaCvCameraFrame {
     ...
     * See {@link JavaCvCameraFrame#getBestSize(List, int)} for more information.
     */
    ...
    private class CameraWorker implements Runnable {
        public void run() {
            do {
                ...
                synchronized (JavaCvCameraFrame.this) {
                    try {
                        while (!cameraFrameReady && !stopThread) {
                            JavaCvCameraFrame.this.wait();
                        }
                    } catch (InterruptedException e) {
